...
application.add_url_rule(
    '/article/<string:url>',
    None,
    BlogController.show_article)
application.add_url_rule(
    '/categorie/<string:category>/<int:page>',
    None,
    BlogController.show_category)
application.add_url_rule(
    ...
    defaults={
        'page': 0})
application.add_url_rule(
    '/type/<string:type>/<int:page>',
    None,
    BlogController.show_type)
application.add_url_rule(
    '/type/<string:type>',
    None,
    BlogController.show_type,
...
application.add_url_rule(
    ...
    None,
    MembersController.show_user_page)
...
application.add_url_rule(
    '/page/embed/<string:source>',
    None,
    PageController.rss_embed)
...
application.add_url_rule(
    '/page/search/',
    None,
    PageController.show_search,
    defaults={
        'keyword': None,
        'page': 0})
application.add_url_rule(
    '/page/search/<string:keyword>/',
    None,
    PageController.show_search,
    defaults={
        'page': 0})
application.add_url_rule(
    '/page/search/<string:keyword>/<int:page>/',
    None,
    PageController.show_search)
...
application.add_url_rule(
    '/blog/<string:url>-<int:id>',
    None,
    RedirectsController.redirect_old_url_blog)
application.add_url_rule(
    '/courses/',
    None,
    RedirectsController.redirect_courses)
application.add_url_rule(
    '/courses/<whatever>',
    None,
    RedirectsController.redirect_courses)
...
application.add_url_rule(
    '/community/',
    None,
    RedirectsController.redirect_about)
